function sysCall_init() 
    s=sim.getObjectHandle('suctionPadSensor#0')
    l=sim.getObjectHandle('suctionPadLoopClosureDummy1#0')
    l2=sim.getObjectHandle('suctionPadLoopClosureDummy2#0')
    b=sim.getObjectHandle('suctionPad#0')
    ...
    -- sim.setIntegerSignal(vacuumCupName..'_active',1) -- activate
